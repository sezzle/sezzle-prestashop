...
var sezzleCheckoutRender = function(){
    ...
    var observer = new MutationObserver(function(){
        document.querySelector('#sezzle-checkout-widget').innerHTML = '';
        renderInstallmentWidget(checkoutTotal, merchantLocale, currencySymbol);
    });
...
var sezzleRenderInterval = setInterval(function(){
    if(sezzleCheckoutRender()){
        clearInterval(sezzleRenderInterval);
    }
}, 500);
...
function renderInstallmentWidget(checkoutTotal, serviceRegion, currencySymbol){
    ...
    if(!installmentBox.querySelector('.sezzle-payment-schedule-container')){
        ...
        function currencyType (priceText){
            ...
            if(currencySymbol){
                ...
                for(var i = 0; i < priceText.length; i++){
                    ...
                    // if(priceText[i] == String.fromCharCode(8364)){ //â‚¬ = 8364, 128 = Â€, 163 = Â£, 8377 = â‚¹
        ...
        console.log(totalPriceText, price, currency, includeComma);
